  ...
  return (
    <>
      ...
      <aside className="hidden md:flex fixed left-0 top-0 h-screen w-16 hover:w-56 bg-[#0a0a0a] border-r border-white/10 flex-col z-50 transition-all duration-300 group/sidebar overflow-hidden">
        {/* Logo */}
        <Link to="/" className="flex items-center gap-3 px-4 h-16 border-b border-white/10 shrink-0">
          <span className="text-2xl font-black bg-gradient-to-r from-[#f72585] to-[#00f5ff] bg-clip-text text-transparent">V</span>
          <span className="text-lg font-black text-white opacity-0 group-hover/sidebar:opacity-100 transition-opacity duration-300 whitespace-nowrap">VOLT</span>
        </Link>
        ...
        <div className="border-t border-white/10 p-3">
          ...
          >
            ...
            <span className="opacity-0 group-hover/sidebar:opacity-100 transition-opacity duration-300 whitespace-nowrap">Login</span>
          </Link>
        </div>
      </aside>
